<html>
    <head>
        <meta charset="UTF-8" />
        <title>Home × DeinServer.net</title>
        ...
        <div class="container-fluid">
            <div class="header">
			    ...
			    <li><a href="shop.php"><i class="fa fa-address-card"></i> Shop</a></li>
                            <li><a href="apply.html"><i class="fa fa-code"></i> Bewerben</a></li>
                        </ul>
            ...
            <div class="row">
                    <div class="col-md-12 title">
                        ...
                        <hr />
                        <h4>Der Slogan deines Servers</h4>
		</div>
	</div>
			...
			<li><a href="datenschutz.php">Datenschutz</a></li>
                ...
                <div class="col-md-12 socialmedia">
                    <p>
                        &copy; <a href="https://www.mineweb.tk">MineWEB</a> | V0.2-A/B <a href="https://www.mineweb.eu"></a>
                    </p>
                </div>
            </div>
        </div>
